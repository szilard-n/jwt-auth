...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     */
    public static final Set<String> pathWhiteList = Set.of("/api/v1/auth/sign-up", "/api/v1/auth/sign-in");
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        final String jwt = jwtService.validateAndExtractJwt(bearerToken);
